...
export const TodayView: React.FC<TodayViewProps> = ({
  ...
  // Estimated cycle projection for today (used when stale or no active cycle)
  ...
  // Selected cycle day: use estimated day when stale, else default 1
  const [selectedDay, setSelectedDay] = useState<number>(
    isCycleStale ? (estToday.cycleDay || 1) : 1
  );
  ...
  const handleSave = async (options?: {
    ...
    // If stale cycle and user has NOT selected menstruation, save directly into estimated cycle day
